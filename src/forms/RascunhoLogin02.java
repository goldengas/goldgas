 ...
 * @author Xande
 */
public class RascunhoLogin02 extends javax.swing.JFrame {
    ...
    private void validarLogin()
    {
        ...
        if(f2 != null){
            ...
            { 
                RascunhoPrincipalGerente02 fpg = new RascunhoPrincipalGerente02();
                this.dispose();
                fpg.setVisible(true);
            }
            else
            {
                ...
                RascunhoPrincipalFuncionario fpf = new RascunhoPrincipalFuncionario();
                this.dispose();
                fpf.setVisible(true);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RascunhoLogin02.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RascunhoLogin02().setVisible(true);
            }
        });
    }
